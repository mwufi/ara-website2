                ...
                <div className="bg-white">
                    ...
                    <div className="space-y-32 px-4 md:px-8 py-32">
                        ...
                        >
                            <FlipCard
                                isFlipped={isFlipped}
                                back={<ContactForm onBack={() => setIsFlipped(false)} />}
                            >
                        ...
                        >
                            <TactileButton
                                ...
                                className={`inline-flex items-center gap-2 text-white px-8 py-4 rounded-full text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 ${
                                    isFlipped 
                                    ? 'bg-gradient-to-r from-gray-400 to-gray-500 opacity-50 cursor-not-allowed' 
                                    : 'bg-gradient-to-r from-purple-500 to-pink-500 animate-gradient'
                                }`}
                                disabled={isFlipped}
                            >
